...
class Info(commands.Cog):
    ...
    async def about(self,ctx):
        em = discord.Embed(description=" ",color=discord.Color.red())
        ...
        em.add_field(name="Why did Frea even exist",value=f"This bot is an instance of [Red, an open source Discord bot](https://github.com/Cog-Creators/Red-DiscordBot) created by [Twentysix](https://github.com/Twentysix26) and [improved by many.](https://github.com/Cog-Creators)",inline=False)
        em.add_field(name="Story Behind Frea",value=f"Frea was made by Sechi, also one of Elixir's devs, and then maintained by the community.\n\n**Quick Links**\n[Status Page](https://status.pranchi.xyz) | [Support Server](https://dsc.gg/frea) | [GitHub](https://github.com/devpranchi/frea-discord)",inline=False)
